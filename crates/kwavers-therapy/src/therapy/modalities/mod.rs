...
//!
//! ```rust,no_run
//! use kwavers_therapy::therapy::modalities::{
//!     DomainTherapyModality as TherapyModality, DomainTherapyMechanism as TherapyMechanism,
//! };
//!
...
//! ```rust,ignore
//! use kwavers_domain::therapy::modalities::{TherapyModality, TherapyMechanism};
//! ```
//!
//! ### New Import (Correct Location)
//! ```rust,ignore
//! use crate::therapy::modalities::{TherapyModality, TherapyMechanism};
//! ```
//!
