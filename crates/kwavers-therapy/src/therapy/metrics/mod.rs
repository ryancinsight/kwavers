...
//!
//! ```rust,no_run
//! use kwavers_therapy::therapy::metrics::DomainTreatmentMetrics as TreatmentMetrics;
//! use ndarray::Array3;
//!
...
//! ```rust,ignore
//! use kwavers_domain::therapy::metrics::TreatmentMetrics;
//! ```
//!
//! ### New Import (Correct Location)
//! ```rust,ignore
//! use crate::therapy::metrics::TreatmentMetrics;
//! ```
//!
