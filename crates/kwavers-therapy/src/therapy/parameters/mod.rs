...
//!
//! ```rust,ignore
//! use kwavers_therapy::therapy::parameters::TherapyParameters;
//!
...
//! ```rust,ignore
//! use kwavers_domain::therapy::parameters::TherapyParameters;
//! ```
//!
//! ### New Import (Correct Location)
//! ```rust,ignore
//! use crate::therapy::parameters::TherapyParameters;
//! ```
