...
//!
//! ### Former approach (flat `par_iter_mut` with index decomposition)
//!
...
//!
//! ### Current approach (x-slab outer Rayon + sequential y,z loops)
//!
//! Rayon splits on the x-axis only.  Each x-slab thread maintains `x`, `y`, `z`
...
/// # Algorithm
///
/// Parallelises over x-slabs via Rayon.  For each interior x-slab
...
pub(super) fn update_cells(buffers: UpdateCells<'_>, n: usize, dt: f64, inv_dx2: f64, step: usize) {
    ...
    // Interior x-slabs: Rayon splits across x in [1, n-1).
