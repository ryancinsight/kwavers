use crate::therapy::theranostic_guidance::nonlinear3d::types::{
    GridIndex, Nonlinear3dAperture, SourceDomain,
};
use crate::therapy::theranostic_guidance::Point3;
use kwavers_core::constants::fundamental::{SOUND_SPEED_AIR, SOUND_SPEED_WATER_SIM};
...
fn source_injection_imposes_bounded_pressure_without_accumulating_drive() {
    use crate::therapy::theranostic_guidance::nonlinear3d::types::Nonlinear3dConfig;
