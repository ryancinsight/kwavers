...
pub(in crate::therapy::theranostic_guidance::nonlinear3d::forward) struct SourcePlan {
...
pub(in crate::therapy::theranostic_guidance::nonlinear3d::forward) fn build_source_plan(
    speed: &[f64],
    n: usize,
    spacing_m: f64,
...
pub(in crate::therapy::theranostic_guidance::nonlinear3d) fn source_plan_metrics(
    speed: &[f64],
    n: usize,
    spacing_m: f64,
    aperture: &Nonlinear3dAperture,
