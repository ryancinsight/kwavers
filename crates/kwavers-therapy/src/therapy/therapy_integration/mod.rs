...
//!
//! ```
//! use kwavers_therapy::therapy::therapy_integration::{
...
//! let medium = HomogeneousMedium::new(kwavers_core::constants::fundamental::DENSITY_WATER_NOMINAL, kwavers_core::constants::fundamental::SOUND_SPEED_TISSUE, 0.5, 1.0, &grid);
//!
//! // Create orchestrator
