...
impl ComplexLinearAlgebra {
    ...
    pub fn solve_linear_system_complex(
        ...
        let mut a_data = a
            .as_slice()
            .expect("complex linear solve expects contiguous matrix storage")
            .to_vec();
        let mut b_data = b
            .as_slice()
            .expect("complex linear solve expects contiguous vector storage")
            .to_vec();
    ...
    pub fn matrix_inverse_complex(
        ...
        for col in 0..n {
            ...
            let xs = x
                .as_slice()
                .expect("complex linear solve output must remain contiguous");
            for row in 0..n {
...
mod tests {
    ...
    fn test_solve_complex_linear_system() {
        ...
        let b = Array1::from_vec(vec![Complex64::new(3.0, 1.0), Complex64::new(2.0, -1.0)]);
        ...
        let a_sl = a
            .as_slice()
            .expect("test matrix from_shape_vec must be contiguous");
        let x_sl = x
            .as_slice()
