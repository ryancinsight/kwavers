...
FINITE_WINDOW_PSTD_BORN_SECOND_ORDER_MODEL = "pstd_finite_window_born_second_order"
REPORT_PREDICTION_MODELS = (
    *PROPAGATION_MODELS,
    FINITE_WINDOW_PSTD_BORN_MODEL,
    FINITE_WINDOW_PSTD_BORN_SECOND_ORDER_MODEL,
)
...
def simulate_pstd_finite_window_born_second_order_stack(
    kw: Any,
    sound_speed_m_s: np.ndarray,
    array: Any,
    frequencies_hz: Sequence[float],
    ...
    return np.stack(
        [
            kw.simulate_breast_fwi_pstd_finite_window_born_second_order_observation(
                sound_speed_m_s,
                array,
                frequency_hz,
                reference_sound_speed_m_s=reference_sound_speed_m_s,
...
def simulate_report_predictions(
    ...
    predictions[FINITE_WINDOW_PSTD_BORN_SECOND_ORDER_MODEL] = (
        simulate_pstd_finite_window_born_second_order_stack(
            kw,
            sound_speed_m_s,
            array,
            frequencies_hz,
