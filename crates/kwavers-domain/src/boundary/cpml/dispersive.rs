...
impl DispersiveParameters {
    ...
    pub fn cole_cole(tau: f64, alpha: f64, epsilon_s: f64, epsilon_inf: f64) -> Self {
        ...
        //
        // Not yet implemented: full multi-pole CPML. Absent: broadband multi-pole CPML
        // for 1–100 MHz ultrasound; Kramers-Kronig constrained dispersive material models
        // (Cole & Cole 1941); anisotropic CPML for directional absorption; genetic-algorithm
        // parameter optimization; and uniaxial perfectly matched layer (UPML) for
