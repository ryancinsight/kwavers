...
use kwavers_source::{
    ...
    BesselSource, DomainSourceParameters, GaussianSource, PlaneWaveSource, PointSource, Source,
    SourceModel, SphericalSource,
};
        ...
        match config.model {
            ...
            SourceModel::PlaneWave => {
                let wave_config = PlaneWaveSourceConfig {
                    ...
                    injection_mode: kwavers_source::InjectionMode::default(),
                };
