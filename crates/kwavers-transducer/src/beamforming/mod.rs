...
//! ```rust,ignore
//! // OLD (deprecated):
//! use kwavers_transducer::beamforming::adaptive::MinimumVariance;
//! use kwavers_transducer::beamforming::neural::AIEnhancedBeamformingProcessor;
//! use kwavers_transducer::beamforming::beamforming_3d::BeamformingProcessor3D;
//!
//! // NEW (recommended):
...
//! ```rust,ignore
//! // OLD (deprecated):
//! use kwavers_transducer::beamforming::neural::{NeuralClinicalDecisionSupport, DiagnosisAlgorithm};
//!
//! // NEW (recommended):
...
//!
//! ```rust,ignore
//! use kwavers_receiver::GridSensorSet + kwavers_transducer::beamforming::SensorBeamformer;
