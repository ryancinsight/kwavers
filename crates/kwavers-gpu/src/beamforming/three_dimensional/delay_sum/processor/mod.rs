...
#[cfg(feature = "gpu")]
use kwavers_analysis::signal_processing::beamforming::three_dimensional::BeamformingConfig3D;

/// GPU delay-and-sum beamforming implementation.
///
/// Only available when the `gpu` feature is enabled. Construction is owned by
/// [`crate::beamforming::three_dimensional::WgpuBeamformingProvider`].
#[cfg(feature = "gpu")]
