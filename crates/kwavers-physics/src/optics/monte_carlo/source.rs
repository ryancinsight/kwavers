...
use crate::optics::monte_carlo::scatter::{get_perpendicular, normalize, sample_isotropic_direction};
    ...
    pub(crate) fn launch_photon<R: Rng>(&self, rng: &mut R) -> Photon {
        match self {
            ...
            Self::Gaussian {
                ...
                let perp2 = crate::optics::monte_carlo::scatter::cross(dir_norm, perp1);
