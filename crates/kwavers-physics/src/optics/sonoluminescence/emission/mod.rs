...
//! - Classical emission models only (bremsstrahlung, Cherenkov, blackbody);
//!   relativistic QED corrections (Lamb shift, spontaneous emission) are
//!   out of scope for this semiclassical simulator.
//!
//! **References:**
