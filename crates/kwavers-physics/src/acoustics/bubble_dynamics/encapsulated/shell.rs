...
impl Default for ShellProperties {
    fn default() -> Self {
        ...
        use kwavers_core::constants::cavitation::DENSITY_SHELL_LIPID;
        Self {
...
impl ShellProperties {
    ...
    pub fn protein_shell() -> Self {
        use kwavers_core::constants::cavitation::DENSITY_SHELL_PROTEIN;
        Self {
    ...
    pub fn polymer_shell() -> Self {
        use kwavers_core::constants::cavitation::DENSITY_SHELL_POLYMER;
        Self {
