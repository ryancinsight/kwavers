...
use kwavers_core::constants::acoustic_parameters::BLOOD_VISCOSITY_37C;
...
impl VesselCooling {
    ...
    /// Uses [`kwavers_core::constants::acoustic_parameters::BLOOD_VISCOSITY_37C`] and
    /// [`kwavers_core::constants::tissue_acoustics::DENSITY_BLOOD`] as SSOT values.
