...
pub mod swe_validation {
    use super::*;
    use kwavers_physics::acoustics::imaging::modalities::elastography::DisplacementField;
    ...
    pub fn validate_elasticity_reconstruction(
        ...
        // Create SWE workflow
        let config = kwavers_solver::inverse::elastography::ShearWaveInversionConfig::new(
