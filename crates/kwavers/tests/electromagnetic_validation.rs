...
fn validate_gpu_acceleration_setup() {
    ...
    use kwavers_analysis::ml::pinn::electromagnetic_gpu::EMConfig;
    ...
    let solver_result = kwavers_analysis::ml::pinn::electromagnetic_gpu::GPUEMSolver::new(config);
...
fn validate_gpu_field_data_structure() {
    ...
    use kwavers_analysis::ml::pinn::electromagnetic_gpu::{EMConfig, GPUEMSolver};
