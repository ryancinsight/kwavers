...
//!   `kwavers_domain::sensor::beamforming::capon_spatial_spectrum_point_complex_baseband`.
//!
...
use kwavers_analysis::signal_processing::beamforming::narrowband::capon::{
...
use kwavers_domain::sensor::Position;
use ndarray::Array3;
