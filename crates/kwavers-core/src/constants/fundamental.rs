...
//!
//! Tissue-specific acoustic properties → [`super::tissue_acoustics`].
//! CT Hounsfield-unit thresholds → [`super::ct_acoustics`].
//! Both are re-exported at the flat [`super`] level via `mod.rs`.
