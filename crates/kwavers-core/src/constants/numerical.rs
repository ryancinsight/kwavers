...
/// Second-order backward difference interior coefficient.
///
...
// ============================================================================
// Adaptive Beamforming Constants
// ============================================================================

/// Default diagonal-loading (white-noise-gain) regularization for adaptive
/// beamformers (Capon/MVDR and their subspace variants).
///
/// Added to the sample covariance diagonal as `R + γI` to bound the white-noise
/// gain and stabilize the inverse when `R` is ill-conditioned or rank-deficient
/// (few snapshots). `1e-6` (relative to a unit-normalized covariance) is the
/// standard light-loading default; the value is a single source of truth shared
/// by every adaptive beamformer's `Default`.
///
/// Reference: Carlson (1988), IEEE Trans. Aerosp. Electron. Syst. 24(4):397–401
/// ("Covariance matrix estimation errors and diagonal loading in adaptive arrays").
pub const DEFAULT_DIAGONAL_LOADING: f64 = 1e-6;
