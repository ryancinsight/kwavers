...
pub use numa::{
    cache_capacity_bytes, current_numa_node, detect_topology, first_touch_memory_parallel,
    last_level_cache_bytes, set_thread_affinity, try_current_numa_node, CpuTopology, NumaAllocator,
    NumaNodeId, PlacementHint, ThreadAffinity, PAGE_SIZE,
};
pub use pool::{
