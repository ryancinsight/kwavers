...
use kwavers_core::constants::medical::{MI_LIMIT_SOFT_TISSUE, TI_LIMIT_SOFT_TISSUE};
    ...
    fn default() -> Self {
        ...
        let bmode_reqs = ClinicalRequirements {
            ...
            safety_thresholds: [
                ...
                ("thermal_index".to_owned(), TI_LIMIT_SOFT_TISSUE),
            ]
            .into(),
        ...
        let safety_reqs = ClinicalRequirements {
            ...
            safety_thresholds: [
                ...
                ("thermal_index_soft_max".to_owned(), TI_LIMIT_SOFT_TISSUE),
