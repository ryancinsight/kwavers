...
mod tests {
    ...
    fn capon_module_exports_accessible() {
        ...
        let cfg = CaponSpectrumConfig {
            ...
            covariance:
                crate::signal_processing::beamforming::covariance::CovarianceEstimator {
                    forward_backward_averaging: false,
                    num_snapshots: 1,
                    post_process: CovariancePostProcess::None,
                },
            steering: crate::signal_processing::beamforming::utils::steering::SteeringVectorMethod::SphericalWave {
