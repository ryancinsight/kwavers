...
//!
//! ```ignore
//! use kwavers_analysis::signal_processing::beamforming::neural::distributed::DistributedNeuralBeamformingProcessor;
//! use kwavers_math::ml::pinn::multi_gpu_manager::{PinnBeamformingDecompositionStrategy, LoadBalancingAlgorithm};
//!
