...
//! [`LinearBornInversionConfig`](kwavers_solver::inverse::linear_born_inversion::LinearBornInversionConfig)
...
pub use kwavers_core::constants::acoustic_parameters::SOUND_SPEED_SKULL;
pub use kwavers_core::constants::fundamental::{SOUND_SPEED_TISSUE, SOUND_SPEED_WATER_SIM};
...
impl Default for TranscranialUstBornInversionConfig {
    fn default() -> Self {
        // Brain-tissue reference: c₀ = SOUND_SPEED_TISSUE (1546 m/s), ρ₀ = DENSITY_BRAIN (1040 kg/m³).
        ...
        let linear = LinearBornInversionConfig {
            reference_sound_speed_m_s: SOUND_SPEED_TISSUE,
