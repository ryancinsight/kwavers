...
impl CurvedArrayShiftScan {
    ...
    ///
    /// # Errors
    /// Returns [`kwavers_core::error::KwaversError`] when the array geometry is
    /// invalid.
    pub fn elements(
        &self,
    ) -> KwaversResult<Vec<kwavers_solver::inverse::same_aperture::PlanarPoint>> {
        self.array.elements()
    }
    ...
    ///
    /// # Errors
    /// Returns [`kwavers_core::error::KwaversError`] when the geometry,
