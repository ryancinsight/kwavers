...
pub use diagnostics::{
    ...
    reconstruction_metrics, scaled_observation_residual_metrics, scattering_increment_diagnostics,
    sine_frequency_bin_coefficient, source_channel_residual_diagnostics,
    source_excitation_diagnostics, source_receiver_mask, table1_parity,
    BreastUstAcquisitionIdentifiability, BreastUstForwardOperatorEquivalenceDiagnostics,
    BreastUstForwardOperatorModelDiagnostics, BreastUstForwardOperatorPrediction,
    BreastUstObservationPairDiagnostics, BreastUstReceiverChannelPolicy,
