...
use kwavers_core::constants::tissue_acoustics::{
    ACOUSTIC_ABSORPTION_BRAIN_GRAY, ACOUSTIC_ABSORPTION_FAT, ACOUSTIC_ABSORPTION_KIDNEY_CORTEX,
    ACOUSTIC_ABSORPTION_LIVER, ACOUSTIC_ABSORPTION_MUSCLE_TRANSVERSE, B_OVER_A_BRAIN, B_OVER_A_FAT,
    B_OVER_A_KIDNEY, B_OVER_A_LIVER, B_OVER_A_MUSCLE, B_OVER_A_SOFT_TISSUE, B_OVER_A_WATER,
    DENSITY_BRAIN, DENSITY_FAT, DENSITY_LIVER, DENSITY_MUSCLE, SOUND_SPEED_BRAIN, SOUND_SPEED_FAT,
    SOUND_SPEED_KIDNEY, SOUND_SPEED_LIVER, SOUND_SPEED_MUSCLE, WATER_ABSORPTION_ALPHA_0_DB_CM_MHZ2,
};
use std::fmt;
...
mod tests {
    use super::*;
    use kwavers_core::constants::fundamental::{
        DENSITY_WATER_NOMINAL, SOUND_SPEED_WATER, SOUND_SPEED_WATER_SIM,
    };
