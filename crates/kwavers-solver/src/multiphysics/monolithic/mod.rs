...
pub mod coupler;
pub mod residual;
pub(in crate::multiphysics::monolithic) mod residual_metric;
pub(in crate::multiphysics::monolithic) mod spatial_operator;
pub(in crate::multiphysics::monolithic) mod state_vector;
