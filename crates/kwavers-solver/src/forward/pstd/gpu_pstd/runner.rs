...
//! kwavers lets clinical adapters (e.g. [`crate::clinical::imaging::reconstruction::breast_ust_fwi::dataset`])
//! drive the GPU path directly when the `gpu` feature is enabled.
//!
...
use crate::forward::pstd::gpu_pstd::{
