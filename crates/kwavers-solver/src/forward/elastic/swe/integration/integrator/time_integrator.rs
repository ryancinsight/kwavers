...
use super::super::super::boundary::ElasticSwePMLBoundary;
use super::super::super::scratch::ElasticStepScratch;
use super::super::super::stress::stress_divergence_into;
...
impl<'a> TimeIntegrator<'a> {
    ...
    pub fn step(
        ...
        if let Some(body_force) = body_force {
            super::body_force::validate(body_force)?;
        }
                ...
                |chunk_idx, ax_chunk, ay_chunk, az_chunk| {
                    ...
                    for offset in 0..ax_chunk.len() {
                        ...
                        for bf in body_forces {
                            let f = super::body_force::evaluate(grid, bf, i, j, k, time);
                            force[0] += f[0];
                            force[1] += f[1];
                            force[2] += f[2];
                        }
