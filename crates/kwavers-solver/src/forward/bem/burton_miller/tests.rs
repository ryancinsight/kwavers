...
fn test_greens_function_helmholtz() {
    let cfg = BurtonMillerConfig::new(100_000.0, SOUND_SPEED_WATER_SIM);
    let g = BurtonMillerAssembler::greens_function_helmholtz(cfg.wavenumber, 0.1);
...
fn test_triangle_normal() {
    ...
    let n2 = [1.0, 0.0, 0.0];
    let n3 = [0.0, 1.0, 0.0];
    let normal = BurtonMillerAssembler::triangle_normal(n1, n2, n3);
...
fn test_triangle_area() {
    ...
    let n2 = [1.0, 0.0, 0.0];
    let n3 = [0.0, 1.0, 0.0];
    let area = BurtonMillerAssembler::triangle_area(n1, n2, n3);
...
fn test_distance() {
    let p1 = [0.0, 0.0, 0.0];
    let p2 = [3.0, 4.0, 0.0];
    let dist = BurtonMillerAssembler::distance(&p1, &p2);
...
fn test_hypersingular_parallel_normals_matches_formula() {
    ...
    let result = BurtonMillerAssembler::greens_function_double_normal_derivative(
        k,
        r,
        &collocation,
        &point,
    ...
    let g = BurtonMillerAssembler::greens_function_helmholtz(k, r);
