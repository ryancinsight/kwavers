...
pub struct PersistentAdamState<B: Backend> {
    ...
    pub first_moments: crate::inverse::pinn::elastic_2d::model::ElasticPINN2D<B>,
    /// Second moment estimates (exponential moving average of squared gradients).
    pub second_moments: crate::inverse::pinn::elastic_2d::model::ElasticPINN2D<B>,
...
impl<B: Backend> PersistentAdamState<B> {
    ...
    pub fn new(
        model: &crate::inverse::pinn::elastic_2d::model::ElasticPINN2D<B>,
        beta1: f64,
        beta2: f64,
        epsilon: f64,
    ) -> Self {
...
pub struct MomentumState<B: Backend> {
    ...
    pub velocity: crate::inverse::pinn::elastic_2d::model::ElasticPINN2D<B>,
