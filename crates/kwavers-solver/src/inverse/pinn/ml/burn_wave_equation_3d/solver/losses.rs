        ...
        coeus_core::CpuAddressableStorage<f32> + coeus_core::CpuAddressableStorageMut<f32>,
{
    ...
    pub(crate) fn compute_physics_loss(
        ...
        let pde_loss_raw =
            coeus_autograd::mean(&coeus_autograd::mul(&pde_residual, &pde_residual));
        ...
        let ic_disp_loss =
            coeus_autograd::mean(&coeus_autograd::mul(&ic_disp_diff, &ic_disp_diff));
    ...
    pub(crate) fn compute_bc_loss_internal(&self) -> Var<f32, B> {
        ...
        let mk = |v: &[f32]| Var::new(coeus_tensor::Tensor::from_slice_on(vec![n, 1], v, &backend), false);
