...
fn test_trainer_creation() {
    ...
    let trainer = BurnPINNTrainer::<TestBackend>::new(config);
...
fn test_pinn_accessor() {
    ...
    let trainer = BurnPINNTrainer::<TestBackend>::new(config).unwrap();
...
fn test_optimizer_accessor() {
    ...
    let trainer = BurnPINNTrainer::<TestBackend>::new(config.clone()).unwrap();
