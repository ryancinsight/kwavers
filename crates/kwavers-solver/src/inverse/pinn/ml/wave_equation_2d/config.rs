...
impl Default for PinnConfig2D {
    fn default() -> Self {
        Self {
            hidden_layers: vec![100, 100, 100, 100],
            learning_rate: 1e-3,
            loss_weights: LossWeights2D::default(),
...
impl Default for LossWeights2D {
    fn default() -> Self {
        Self {
            data: 1.0,
            pde: 1.0,
