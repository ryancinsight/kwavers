...
use super::interface::WaveInterfaceCondition2D;

/// 2D geometry definitions for PINN domains.
pub enum WaveGeometry2D {
    ...
    AdaptiveMesh {
        base_geometry: Box<WaveGeometry2D>,
        refinement_threshold: f64,
        max_level: usize,
    },
    /// Multi-region composite domain.
    MultiRegion {
        regions: Vec<(WaveGeometry2D, usize)>,
        interfaces: Vec<WaveInterfaceCondition2D>,
    },
}
