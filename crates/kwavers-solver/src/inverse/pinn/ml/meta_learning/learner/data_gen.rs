    ...
    fn generate_boundary_data(
        ...
        let push_point = |points: &mut Vec<(f64, f64, f64, f64)>, x: f64, y: f64, t: f64| {
            ...
            let bc = conditions
                .get(idx)
                .copied()
                .unwrap_or(crate::inverse::pinn::ml::BoundaryCondition2D::Dirichlet);
            let bc_value = match bc {
                crate::inverse::pinn::ml::BoundaryCondition2D::Dirichlet => 0.0,
                crate::inverse::pinn::ml::BoundaryCondition2D::Neumann => 0.0,
                crate::inverse::pinn::ml::BoundaryCondition2D::Periodic => 0.0,
                crate::inverse::pinn::ml::BoundaryCondition2D::Absorbing => 0.0,
            };
        ...
        for i in 0..n_ic {
            ...
            let (u0, v0) = match pattern {
                ...
                1 => {
                    ...
                    let v0 = if matches!(
                        task.pde_type,
                        crate::inverse::pinn::ml::meta_learning::types::PdeType::Wave
                            | crate::inverse::pinn::ml::meta_learning::types::PdeType::Acoustic
                            | crate::inverse::pinn::ml::meta_learning::types::PdeType::Elastic
                    ) {
