//! Coeus-backed 3D Wave Equation Physics-Informed Neural Network with Automatic Differentiation
//!
...
//!     PinnWave3D, PinnConfig3D, Geometry3D
//! };
...
//!     let mut pinn = PinnWave3D::<Backend>::new(config, geometry, wave_speed)?;
//!
...
//!
//! let pinn = PinnWave3D::<Backend>::new(config, geometry, wave_speed)?;
//!
//! // Verify wave speeds
