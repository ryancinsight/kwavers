...
///
/// ```rust,ignore
/// use kwavers_solver::inverse::pinn::ml::wave_equation_3d::PinnConfig3D;
///
...
pub struct PinnConfig3D {
    ...
    pub loss_weights: LossWeights3D,
...
impl Default for PinnConfig3D {
    fn default() -> Self {
        Self {
            ...
            loss_weights: LossWeights3D::default(),
            learning_rate: 1e-4,
            batch_size: 1000,
            max_grad_norm: 1.0,
        }
...
///
/// ```rust,ignore
/// use kwavers_solver::inverse::pinn::ml::wave_equation_3d::LossWeights3D;
///
...
impl Default for LossWeights3D {
    fn default() -> Self {
        Self {
            data_weight: 1.0,
            pde_weight: 1.0,
...
///
/// ```rust,ignore
/// use kwavers_solver::inverse::pinn::ml::wave_equation_3d::TrainingMetrics3D;
///
