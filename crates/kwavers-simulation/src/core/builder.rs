...
pub struct SimulationBuilder<'a, M: Medium> {
    ...
    feature_config: kwavers_solver::feature::FeatureBasedConfig,
...
impl<'a, M: Medium> SimulationBuilder<'a, M> {
    ...
    pub fn new() -> Self {
        Self {
            ...
            sources: Vec::new(),
            sensors: Vec::new(),
            feature_config: kwavers_solver::feature::FeatureBasedConfig::default(),
    ...
    pub fn build(self) -> KwaversResult<CoreSimulation<'a, M>> {
        ...
        let progress_reporter: Box<dyn kwavers_solver::interface::ProgressReporter> =
            Box::new(kwavers_solver::interface::ConsoleProgressReporter::default());
