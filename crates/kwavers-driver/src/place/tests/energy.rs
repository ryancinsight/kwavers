//! Placement energy unit tests.
//!
//! These tests assert specific energy term values from `energy()` calls.
//! Annealing integration tests (running the full SA loop) live in `anneal.rs`.
