...
use super::*;
use crate::board::{Board, LayerId, NetClassKind, NetId, Pad, Track, Via, Zone, ZoneFill};
...
fn comp(fp: usize, refdes: &str, nets: Vec<Option<NetId>>) -> Component {
    Component {
        fp,
        nets,
        refdes: refdes.into(),
...
fn comp_at(fp: usize, refdes: &str, x: f64, y: f64, assoc: Option<usize>) -> Component {
    Component {
        fp,
        nets: Vec::new(),
        refdes: refdes.into(),
