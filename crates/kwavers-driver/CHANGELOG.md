...
- **Phase 6 workspace move + kwavers-transducer wiring**: crate moved from
  a downstream consumer's `driver/kicad-routing/` to `crates/kwavers-driver/` (parent kwavers workspace). Standalone
