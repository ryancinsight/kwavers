...
- File-tree cleanup remains open for other oversized physics files, especially `physics::acoustics::therapy::sonogenetics::channels`, `physics::optics::quantum_optics`, and `physics::acoustics::skull::aberration`.
