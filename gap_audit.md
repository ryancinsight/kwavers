...
- File-tree cleanup remains open for oversized physics files, especially `physics::optics::sonoluminescence::bremsstrahlung`; the next cleanup increment should split plasma state, Gaunt factors, emission model, field assembly, and tests into sibling vertical modules.
