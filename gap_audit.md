...
- `KWAVERS-AEQ-MET-03` is partially implemented: frequency and element
  geometry are closed for this increment; Rayleigh propagation and materials
  remain open. The parent audit must be refreshed after each child slice so the
