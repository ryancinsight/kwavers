...
- File-tree cleanup remains open for other oversized physics files, especially `physics::acoustics::conservation`, `physics::acoustics::therapy::sonogenetics::channels`, and `physics::optics::quantum_optics`.
