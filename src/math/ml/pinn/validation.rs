...
use crate::math::ml::pinn::fdtd_reference::{FDTD1DWaveSolver, FDTDConfig};
use crate::math::ml::pinn::wave_equation_1d::{PINN1DWave, ValidationMetrics};
...
mod tests {
    use super::*;
    use crate::math::ml::pinn::wave_equation_1d::PINNConfig;
