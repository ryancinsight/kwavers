...
// - Beamforming algorithms and numerics are owned by `crate::sensor::beamforming`.
...
///
/// Prefer `crate::sensor::localization::beamforming_search::BeamformSearch`
...
impl Beamformer {
    ...
    pub fn new(array: &SensorArray, frequency: f64, sound_speed: f64) -> Self {
        ...
        for angle_deg in 0..360 {
            ...
            let steering = crate::sensor::beamforming::SteeringVector::compute_plane_wave(
                direction,
                frequency,
                &positions,
                sound_speed,
