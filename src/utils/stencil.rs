...
pub fn gradient_3d<T: StencilValue>(
    ...
    match order {
        StencilOrder::Second => gradient_3d_order2(input, grad_x, grad_y, grad_z, dx_inv, dy_inv, dz_inv),
        StencilOrder::Fourth => gradient_3d_order4(input, grad_x, grad_y, grad_z, dx_inv, dy_inv, dz_inv),
    }
}
