...
//!
//! k-Wave compatible geometry creation functions for transducer masks,
...
//! used in acoustic simulations, matching k-Wave API ergonomics.
//!
//! # k-Wave Migration
//!
//! | k-Wave Function | Kwavers Equivalent | Description |
//! |-----------------|-------------------|-------------|
...
use crate::{grid::Grid, KwaversResult};
use ndarray::Array3;
...
/// and `false` outside, matching k-Wave's `makeBall` function.
///
/// # Arguments
///
/// * `grid` - Grid defining spatial discretization
...
///
/// Provided for k-Wave API compatibility. Functionally identical to [`make_ball`].
///
/// # Arguments
///
/// * `grid` - Grid defining spatial discretization
