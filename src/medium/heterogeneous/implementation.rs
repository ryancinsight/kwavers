...
impl HeterogeneousMedium {
    ...
    pub fn tissue(grid: &Grid) -> Self {
        ...
        // Clone required for independent ownership in struct fields (b_a used twice below)
        // Alternative would require lifetime parameters throughout heterogeneous medium API
