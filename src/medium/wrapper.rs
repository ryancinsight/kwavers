...
use crate::grid::Grid;
use crate::medium::{continuous_to_discrete, CoreMedium};

/// Get density at continuous coordinates
#[inline]
pub fn density_at(medium: &dyn CoreMedium, x: f64, y: f64, z: f64, grid: &Grid) -> f64 {
...
#[inline]
pub fn sound_speed_at(medium: &dyn CoreMedium, x: f64, y: f64, z: f64, grid: &Grid) -> f64 {
    let (i, j, k) = continuous_to_discrete(x, y, z, grid);
...
#[inline]
pub fn absorption_at(medium: &dyn CoreMedium, x: f64, y: f64, z: f64, grid: &Grid) -> f64 {
    let (i, j, k) = continuous_to_discrete(x, y, z, grid);
...
#[inline]
pub fn nonlinearity_at(medium: &dyn CoreMedium, x: f64, y: f64, z: f64, grid: &Grid) -> f64 {
    let (i, j, k) = continuous_to_discrete(x, y, z, grid);
