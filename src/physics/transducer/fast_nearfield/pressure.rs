...
impl PressureFieldCalculator {
    ...
    pub fn compute_pressure_fft(
        ...
        for z_idx in 0..nz {
            ...
            let propagated =
                self.angular_spectrum_propagation(&source_plane, z, k, grid.dx, grid.dy)?;
    ...
    fn angular_spectrum_propagation(
        ...
        for i in 0..nx {
            for j in 0..ny {
                ...
                let transfer =
                    Complex::new(0.0, kz.re * z).exp() * Complex::new(kz.im * z, 0.0).exp();
    ...
    pub fn compute_sir(&self, grid: &Grid, basis: &BasisFunctions) -> KwaversResult<Array3<f64>> {
