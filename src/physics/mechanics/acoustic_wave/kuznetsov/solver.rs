...
impl KuznetsovWave {
    ...
    fn compute_rhs(
        ...
        if include_nonlinearity {
            ...
            let avg_density = crate::medium::density_at(medium, center_x, center_y, center_z, &self.grid);
            let avg_sound_speed = crate::medium::sound_speed_at(medium, center_x, center_y, center_z, &self.grid);
