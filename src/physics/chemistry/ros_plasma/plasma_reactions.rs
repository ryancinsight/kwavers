...
impl PlasmaChemistry {
    ...
    fn initialize_concentrations(&mut self) {
        ...
        self.concentrations.insert("H2O".to_string(), 0.5 * total_conc);
        self.concentrations.insert("N2".to_string(), 0.395 * total_conc); // 79% of air
        self.concentrations.insert("O2".to_string(), 0.105 * total_conc); // 21% of air
        
        // Initialize other species at trace levels
        self.concentrations.insert("H".to_string(), 1e-10 * total_conc);
        self.concentrations.insert("OH".to_string(), 1e-10 * total_conc);
        self.concentrations.insert("O".to_string(), 1e-10 * total_conc);
        self.concentrations.insert("N".to_string(), 1e-10 * total_conc);
        self.concentrations.insert("H2".to_string(), 1e-10 * total_conc);
        ...
        if self.temperature > 10000.0 {
            self.concentrations.insert("H+".to_string(), 1e-15 * total_conc);
            self.concentrations.insert("e-".to_string(), 1e-15 * total_conc);
        }
    }
