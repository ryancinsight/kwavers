...
impl RadicalKinetics {
    ...
    fn add_standard_reactions(&mut self) {
        ...
        self.reactions.push(RadicalReaction {
            ...
            products: vec![(ROSSpecies::HydrogenPeroxide, 1.0), (ROSSpecies::SingletOxygen, 1.0)],
        ...
        self.reactions.push(RadicalReaction {
            ...
            reactants: vec![(ROSSpecies::HydrogenPeroxide, 1.0), (ROSSpecies::HydroxylRadical, 1.0)],
    ...
    pub fn add_scavenger(&mut self, scavenger_name: &str, oh_rate: f64, other_rates: HashMap<ROSSpecies, f64>) {
        // OH scavenging
        if oh_rate > 0.0 {
            self.reactions.push(RadicalReaction {
...
mod tests {
    ...
    fn test_ph_dependence() {
        ...
        let reaction = kinetics_acid.reactions.iter()
