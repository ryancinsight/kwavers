...
use crate::physics::imaging::elastography::elastic_wave_solver::{
    ElasticBodyForceConfig, ElasticWaveConfig, ElasticWaveField, ElasticWaveSolver,
};
use crate::physics::imaging::elastography::inversion::{
    ElasticityMap, InversionMethod, ShearWaveInversion,
};
use crate::physics::imaging::elastography::radiation_force::AcousticRadiationForce;
...
impl ShearWaveElastography {
    ...
    pub fn reconstruct_elasticity(
        ...
        let final_field = displacement_history.last().ok_or_else(|| {
            crate::error::KwaversError::Validation(crate::error::ValidationError::InvalidValue {
