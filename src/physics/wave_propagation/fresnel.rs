...
impl FresnelCalculator {
    ...
    pub fn reflectance(&self, incident_angle: f64, polarization: Polarization) -> KwaversResult<f64> {
        ...
        match polarization {
            ...
            Polarization::Unpolarized => {
                Ok((coeffs.rs * coeffs.rs + coeffs.rp * coeffs.rp) / 2.0)
            }
    ...
    pub fn transmittance(&self, incident_angle: f64, polarization: Polarization) -> KwaversResult<f64> {
...
mod tests {
    ...
    fn test_brewster_angle() {
        ...
        let coeffs = calc.calculate(brewster, transmitted, Polarization::TransverseMagnetic).unwrap();
    ...
    fn test_total_internal_reflection() {
        ...
        let reflectance = calc.reflectance(critical + 0.1, Polarization::Unpolarized).unwrap();
    ...
    fn test_energy_conservation() {
        ...
        for angle in [0.0, PI/6.0, PI/4.0, PI/3.0] {
            for pol in [Polarization::TransverseElectric, 
