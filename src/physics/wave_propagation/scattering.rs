    ...
    pub fn total_cross_section(
        ...
        match regime {
            ...
            ScatteringRegime::Mie => {
                ...
                let (a_n, b_n) = self.mie_coefficients(particle_radius, refractive_index_ratio, 10)?;
        ...
        for i in 0..grid.nx {
            for j in 0..grid.ny {
                for k in 0..grid.nz {
                    ...
                    scattering_coefficient[(i, j, k)] = medium.optical_scattering_coefficient(x, y, z, grid);
