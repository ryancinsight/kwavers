...
use crate::solver::spectral::config::{AbsorptionMode, SpectralConfig};
use crate::solver::spectral::SpectralSolver;
...
impl SpectralSolver {
    ...
    pub(super) fn apply_absorption(&mut self, dt: f64) -> KwaversResult<()> {
...
mod tests {
    ...
    fn test_fft_based_absorption_reduces_amplitude() {
        use crate::medium::HomogeneousMedium;
        use crate::solver::spectral::SpectralSource;
        ...
        let mut solver =
            SpectralSolver::new(config, grid.clone(), &medium, SpectralSource::default()).unwrap();
    ...
    fn test_lossless_mode_no_absorption() {
        ...
        // Initialize Spectral solver in lossless mode
        let config = SpectralConfig {
