...
impl IMEXBDF {
    ...
    fn compute_coefficients(order: usize) -> (Vec<f64>, Vec<f64>) {
        match order {
            ...
            6 => {
                // BDF6
                let alpha = vec![147.0/60.0, -6.0, 15.0/2.0, -20.0/3.0, 15.0/4.0, -6.0/5.0, 1.0/6.0];
...
impl IMEXBDF {
    ...
    pub fn update(&mut self, solution: Array3<f64>, explicit_rhs: impl Fn(&Array3<f64>) -> KwaversResult<Array3<f64>>) -> KwaversResult<()> {
