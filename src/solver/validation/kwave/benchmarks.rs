...
impl KWaveBenchmarks {
    ...
    pub fn point_source_pattern() -> KwaversResult<BenchmarkResult> {
        ...
        Ok(BenchmarkResult {
            ...
            max_error,
            rms_error,
            passed: max_error < 0.15 && rms_error < 0.08,
        })
    }
    ...
    pub fn rigid_boundary_reflection() -> KwaversResult<BenchmarkResult> {
        ...
        Ok(BenchmarkResult {
            ...
            max_error: error,
            rms_error: error,
            passed: error < 0.05, // 5% tolerance for perfect reflection
        })
    }

    /// Test 4: Numerical dispersion analysis
    /// Compares phase velocity error vs analytical solution
    ...
    pub fn numerical_dispersion() -> KwaversResult<BenchmarkResult> {
        ...
        for &freq in &frequencies {
            ...
            for &ppw in &points_per_wavelength {
                ...
                let k_numerical = if k_analytical * dx / 2.0 < 1.0 {
                    (2.0 / dx) * (k_analytical * dx / 2.0).asin()
                } else {
        ...
        Ok(BenchmarkResult {
            ...
            max_error,
            rms_error,
            passed: max_error < 0.05 && rms_error < 0.02, // 5% max, 2% RMS tolerance
        })
    }
