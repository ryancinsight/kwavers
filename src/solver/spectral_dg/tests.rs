...
mod integration_tests {
        ...
        if let Some(mask) = solver.discontinuity_mask() {
            ...
            for j in 10..54 {
                for k in 10..54 {
                    ...
                    assert!(detected, "Failed to detect discontinuity at ({}, {}, {})", 32, j, k);
                }
            }
        }
    ...
    fn test_config_update() {
        ...
        let dt = 0.001;
        let _result = solver.solve(&field, dt, &Grid::new(32, 32, 32, 1.0, 1.0, 1.0)).unwrap();
