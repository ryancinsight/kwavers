...
use crate::domain::sensor::localization::{Position, SensorArray};
...
impl<'a> TrilaterationSolver<'a> {
    ...
    fn fallback_ls(
        ...
        let subset = crate::domain::sensor::localization::array::SensorArray::new(
            subset_sensors,
            self.array.sound_speed(),
            crate::domain::sensor::localization::array::ArrayGeometry::Arbitrary,
        );
