...
use crate::domain::sensor::beamforming::neural::types::{ClinicalAnalysis, FeatureMap};
...
mod tests {
    use super::*;
    use crate::domain::sensor::beamforming::neural::types::{
        LesionDetection, TissueClassification,
    };
