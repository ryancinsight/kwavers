...
//! # Migration Note
//!
//! This module was migrated from `analysis::signal_processing::beamforming::time_domain::delay_reference`
//! to `domain::sensor::beamforming::delay_reference` to eliminate layer violations. The API remains unchanged.
...
///
/// ```rust,ignore
/// use kwavers::domain::sensor::beamforming::DelayReference;
///
