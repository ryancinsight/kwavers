...
//! - This module lives under `crate::domain::sensor::beamforming` and is intended to be used by
...
use crate::domain::sensor::beamforming::narrowband::steering_narrowband::NarrowbandSteering;
...
pub fn capon_spatial_spectrum_point_complex_baseband(
    ...
    let selection = cfg
        ...
        .unwrap_or(SnapshotSelection::Auto(
            crate::domain::sensor::beamforming::narrowband::snapshots::SnapshotScenario {
