...
use crate::error::{KwaversResult, KwaversError, GpuError};
use super::{GpuFftBackend, GpuFftPlan, FftDirection};
use ndarray::Array3;
...
impl GpuFftBackend for CudaFftBackend {
    ...
    fn execute(&mut self, _plan: &GpuFftPlan, _data: &mut Array3<Complex<f64>>) -> KwaversResult<()> {
