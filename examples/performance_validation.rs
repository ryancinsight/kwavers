...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("✅ Grid Creation (100³): {:.2}ms", grid_creation_time.as_secs_f64() * 1000.0);
    ...
    println!("✅ Array3 Creation ({}M elements): {:.2}ms", 
    ...
    println!("✅ Memory Usage: {:.1}MB", memory_usage as f64 / 1_048_576.0);
    ...
    println!("Total Initialization Time: {:.2}ms", total_init_time.as_secs_f64() * 1000.0);
