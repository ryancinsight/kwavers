...
fn run_data_acquisition_demo(params: SimulationParams) -> KwaversResult<()> {
    ...
    println!("==============================");
    println!("Monitoring:");
    println!("  - Cavitation: {}", if params.enable_cavitation { "✓" } else { "✗" });
    println!("  - Sonoluminescence: {}", if params.enable_sonoluminescence { "✓" } else { "✗" });
    println!("  - Thermal Effects: {}", if params.enable_thermal { "✓" } else { "✗" });
    println!();
    ...
    println!("  Total Cavitation Events: {}", stats.total_cavitation_events);
    ...
    println!("  Max Temperature: {:.0} K", stats.max_temperature);
    println!("  Max Light Intensity: {:.2e} W/m²", stats.max_light_intensity);
    println!("  Total SL Photons: {:.2e}", stats.total_sl_photons);
