...
| KWAVERS-AEQ-MET-33 | Type the public plasmonics geometry, wavelength, number-density, cross-section, and complex polarizability contracts with Eunomia-backed Aequitas quantities; keep relative dielectric functions and enhancement factors dimensionless and scalar extraction inside numerical formulas. | [major] | in-progress | Codex | `crates/kwavers-physics/src/electromagnetic/plasmonics/**`, Aequitas `Polarizability`, ADR 071, and synchronized metric PM artifacts |
