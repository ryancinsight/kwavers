...
| KWAVERS-AEQ-MET-46 | Type real-time SIRT frame timestamps, computation budgets, elapsed computation time, throughput, convergence error, and quality ratios with Aequitas; retain RF/image arrays, grid-point smoothing, and raw intensity thresholds at explicit numerical boundaries. | [major] | in-progress | Codex | `crates/kwavers-diagnostics/src/reconstruction/real_time_sirt/**`, ADR 085, PM artifacts |
