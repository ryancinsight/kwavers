...
| KWAVERS-GEN-01 | Consolidate indexed traversal and centered-gradient variants behind monomorphized generic entrypoints; migrate all in-repository callers and remove superseded arity-specific APIs. | [arch] [major] | in-progress | Codex | `crates/kwavers-core/src/utils/iterators.rs`, `crates/kwavers-grid/src/operators/gradient*.rs`, `crates/kwavers-physics/src/parallel.rs`, migrated callers, ADR 079 |
