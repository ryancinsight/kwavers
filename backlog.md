...
| KWAVERS-AEQ-MET-39 | Type neural diagnostics lesion geometry, voxel spacing, beamforming performance targets, and stage timing metrics with Aequitas; keep confidence/utilization dimensionless and memory accounting at the explicit storage-instrumentation boundary. | [major] | in-progress | Codex | `crates/kwavers-diagnostics/src/workflows/neural/{types,clinical,ai_beamforming_processor,diagnosis,workflow}/**`, ADR 077, PM artifacts |
