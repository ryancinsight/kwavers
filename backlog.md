...
|----|---------|-------|--------|-------|-------|
| KWAVERS-AEQ-MET-69 | Type B-mode scan-conversion angles and length geometry with Aequitas; keep scalar extraction at Cartesian raster and interpolation formula boundaries and preserve Eunomia's real geometry rule. | [major] [arch] | done 2026-08-06 | Codex | `crates/kwavers-analysis/src/signal_processing/b_mode/`, ADR 105, `gap_audit.md` |
...
## KWAVERS-AEQ-MET-69 — Type B-mode scan-conversion geometry [major] [arch] — done 2026-08-06
...
- Evidence collected on the clean implementation tree before this ledger-only
  status edit: `kwavers-analysis` library check, warning-denied all-target
  Clippy, B-mode Nextest (9/9), doctests (1 executable, 21 ignored), formatting,
  and diff checks pass. The raw public-signature scan finds no scalar geometry
  fields or compatibility constructors. ADR 105 and the synchronized gap audit
  record the real-valued Eunomia boundary and retain dense RF/image arrays as
  numerical storage.
