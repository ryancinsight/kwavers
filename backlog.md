...
| KWAVERS-AEQ-MET-42 | Type plane-wave compounding angles, frequency, sound speed, geometry, sampling lengths, dynamic range, internal wave quantities, and frame-rate estimates with Aequitas; keep Eunomia coherent images at the complex numerical boundary. | [major] | in-progress | Codex | `crates/kwavers-diagnostics/src/workflows/plane_wave_compounding/**`, ADR 081, PM artifacts |
