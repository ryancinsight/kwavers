...
| KWAVERS-AEQ-MET-43 | Type blood-oxygenation wavelengths, hemoglobin concentration thresholds, and absorption-reference coefficients with Aequitas; keep dense Leto maps and the optical database's scalar formula boundary explicit, with real-valued Eunomia semantics. | [major] | in-progress | Codex | `crates/kwavers-diagnostics/src/workflows/blood_oxygenation.rs`, `crates/kwavers/examples/photoacoustic_blood_oxygenation.rs`, ADR 082, PM artifacts; provider Aequitas ADR 0010 and units landed first |
