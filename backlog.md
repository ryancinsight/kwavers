...
| KWAVERS-AEQ-MET-32 | Type the public MEMS geometry, material, fluid, drive, resonance, pressure, capacitance, and crosstalk contracts with Aequitas; keep dimensionless coupling, quality, bandwidth, and empirical coefficients scalar. | [major] | in-progress | Codex | `crates/kwavers-transducer/src/mems/**`, `transducers/physics/sensitivity.rs`, Aequitas dimensions as required, ADR and synchronized audit artifacts; crosstalk boundary typed in the current increment |
