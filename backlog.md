...
| KWAVERS-AEQ-MET-15 | Type the public cavitation-control frequency, response-time, pressure, temperature, and pulse-timing contracts with Aequitas; keep detector levels, duty cycles, amplitudes, and control scores dimensionless. | [major] | done | Codex | `crates/kwavers-physics/src/acoustics/bubble_dynamics/cavitation_control/**`, migrated therapy callers, PM artifacts |
| KWAVERS-AEQ-MET-16 | Type therapy-integration configuration, session timing, safety-controller timing, intensity, thermal-temperature, and CEM43 contracts with Aequitas; keep mesh arrays and numerical-kernel scalars at explicit boundaries. | [major] | done | Codex | `crates/kwavers-therapy/src/therapy/therapy_integration/{config,state,safety_controller,intensity_tracker,orchestrator/**}`, ADR 054, PM artifacts |
...
| KWAVERS-AEQ-MET-29 | Type the public CEUS imaging, microbubble, population, cloud-dynamics, scattering, reconstruction, and simulation contracts with Aequitas; remove hidden unit conversions and retain dense-array/model boundaries. | [major] | done | Codex | `crates/kwavers-imaging/src/ultrasound/ceus/**`, `crates/kwavers-physics/src/acoustics/imaging/modalities/ceus/**`, `crates/kwavers-simulation/src/imaging/ceus.rs`, ADR 067, PM artifacts |
| KWAVERS-AEQ-MET-30 | Add Aequitas capacitance, conductance, potential, and charge dimensions, then type public sonogenetics membrane and electrical contracts without consumer wrappers. | [major] | done | Codex | `repos/aequitas` electrical dimensions, `crates/kwavers-physics/src/acoustics/therapy/sonogenetics/**`, ADR 068, PM artifacts |
| KWAVERS-AEQ-MET-31 | Type public complex pressure phasors and electrical/acoustic impedance results with Eunomia-backed Aequitas quantities; keep complex numerical arrays and dimensionless model outputs at explicit formula/storage boundaries. | [minor] | done | Codex | `repos/aequitas` complex quantity support and electrical/acoustic impedance, `crates/kwavers-transducer/src/{bulk_piezo.rs,transducers/physics/{frequency,rayleigh}.rs}`, ADR 069, PM artifacts; transducer Nextest 219/219 with one skip and package check pass |
| KWAVERS-AEQ-MET-32 | Type the public MEMS geometry, material, fluid, drive, resonance, pressure, capacitance, damping, sensitivity, and crosstalk contracts with Aequitas; keep dimensionless coupling, quality, bandwidth, and empirical coefficients scalar. | [major] | done | Codex | `crates/kwavers-transducer/src/mems/**`, `transducers/physics/sensitivity.rs`, Aequitas dimensions, ADR 070, and synchronized audit artifacts; commits `1afd09768`, `6d15b5850`; transducer Nextest 219/219 with one skip |
| KWAVERS-AEQ-MET-33 | Type the public plasmonics geometry, wavelength, number-density, cross-section, and complex polarizability contracts with Eunomia-backed Aequitas quantities; keep relative dielectric functions and enhancement factors dimensionless and scalar extraction inside numerical formulas. | [major] | done | Codex | `crates/kwavers-physics/src/electromagnetic/plasmonics/**`, Aequitas `Polarizability`, ADR 071, and synchronized metric PM artifacts; closure committed in `f6a77671e` and recorded in `gap_audit.md` |
| KWAVERS-AEQ-MET-34 | Type GPU/CPU equivalence report peak-pressure and elapsed-time fields with Aequitas `Pressure` and `Time`; keep dense field samples at the Leto numerical boundary and tolerance, divergence, and speedup metrics dimensionless. | [major] | done | Codex | `crates/kwavers-gpu/src/validation/gpu_cpu_equivalence/{report,validator,runner}/**`, ADR 072, PM artifacts; feature Nextest 162/162 with 5 skips; package Clippy collection externally blocked by peer Leto source |
| KWAVERS-AEQ-MET-35 | Type GPU real-time performance budgets, step/kernel/transfer/I/O durations, percentile metrics, throughput, and realtime-loop temporal state with Aequitas `Time`, `Frequency`, and `Dimensionless`; remove unit-suffixed public names and preserve formula-only scalar extraction. | [major] | done | Codex | `crates/kwavers-gpu/src/backend/{performance_monitor,physics_kernels,realtime_loop}/**`, ADR 073, PM artifacts; default Nextest 9/9, feature check passed, feature Nextest reached 162 tests with 161 passes before peer Leto recompilation blocked recollection after the exact test-oracle correction |
| KWAVERS-AEQ-MET-36 | Type the bulk piezoelectric resonator and acoustic matching-layer thickness, area, density, modulus, capacitance, velocity, frequency, and layer-geometry contracts with Aequitas; retain `Complex64` only for shared-unit electrical/acoustic phasors and dimensionless reflection coefficients. | [major] | done | Codex | `crates/kwavers-transducer/src/bulk_piezo.rs`, ADR 074, PM artifacts; package check, Nextest 219/219 with one skip, warning-denied Clippy, doctests 2/2, and rustfmt pass |
| KWAVERS-AEQ-MET-37 | Remove residual unit-suffixed public MEMS verdict pressure fields after the underlying metrics became typed Aequitas `Pressure`; migrate all in-repository callers and retain scalar extraction only for comparison formulas. | [major] | done | Codex | `crates/kwavers-transducer/src/mems/comparison.rs`, ADR 075, PM artifacts; transducer package check, Nextest 219/219 with one skip, warning-denied Clippy, doctests, and rustfmt pass |
| KWAVERS-AEQ-MET-38 | Type visualization configuration, frame/render/transfer timing, frame-rate, latency, quality, drop-rate, and stream-pipeline temporal metrics with Aequitas; retain byte bandwidth as an explicit non-SI storage-rate boundary. | [major] | done | Codex | `crates/kwavers-analysis/src/visualization/{config,metrics,engine,stream,data_pipeline}/**`, ADR 076, PM artifacts; default Nextest 724/724, feature visualization filter 17/17, all-target checks, feature Clippy, doctests, and rustfmt pass; complete feature Nextest exceeds the 60-second suite budget |
| KWAVERS-AEQ-MET-39 | Type neural diagnostics lesion geometry, voxel spacing, beamforming performance targets, and stage timing metrics with Aequitas; keep confidence/utilization dimensionless and memory accounting at the explicit storage-instrumentation boundary. | [major] | done | Codex | `crates/kwavers-diagnostics/src/workflows/neural/{types,clinical,ai_beamforming_processor,diagnosis,workflow}/**`, ADR 077, PM artifacts; focused neural Nextest 41/41, warning-denied Clippy, doctest, Rustdoc, format, and diff gates pass |
| KWAVERS-AEQ-MET-40 | Type clinical workflow orchestration latency, stage timing, GPU utilization, memory accounting, and acquisition/processing timing boundaries with Aequitas where dimensions exist; preserve raw byte accounting only at the explicit storage boundary. | [major] | done | Codex | `crates/kwavers-diagnostics/src/workflows/{config,results,orchestrator}/**`, ADR 078, PM artifacts; package test-target check passes; workflow Nextest 57/57 with 136 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, formatting, and diff checks pass |
| KWAVERS-AEQ-MET-41 | Type functional-ultrasound stereotactic coordinates, Bregma, confidence, and targeting distance with Aequitas; keep scalar extraction only at the atlas millimetre conversion boundary and preserve real-valued Eunomia semantics. | [major] | done | Codex | `crates/kwavers-diagnostics/src/functional_ultrasound/targeting.rs`, direct callers/tests, ADR 080, PM artifacts; package test-target check passes; targeting Nextest 10/10 with 184 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, formatting, and diff checks pass |
| KWAVERS-AEQ-MET-42 | Type plane-wave compounding angles, frequency, sound speed, geometry, sampling lengths, dynamic range, internal wave quantities, and frame-rate estimates with Aequitas; keep Eunomia coherent images at the complex numerical boundary. | [major] | done | Codex | `crates/kwavers-diagnostics/src/workflows/plane_wave_compounding/**`, ADR 081, PM artifacts; package test-target check passes; focused Nextest 10/10 with 185 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, formatting, and diff checks pass |
| KWAVERS-AEQ-MET-43 | Type blood-oxygenation wavelengths, hemoglobin concentration thresholds, and absorption-reference coefficients with Aequitas; keep dense Leto maps and the optical database's scalar formula boundary explicit, with real-valued Eunomia semantics. | [major] | done | Codex | `crates/kwavers-diagnostics/src/workflows/blood_oxygenation.rs`, `crates/kwavers/examples/photoacoustic_blood_oxygenation.rs`, ADR 082, PM artifacts; diagnostics check and example check pass; focused Nextest 3/3 with 195 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, formatting, diff, and raw-public-contract scan pass |
| KWAVERS-AEQ-MET-44 | Type f-k migration lateral spacing, temporal sampling, and sound speed with Aequitas; validate positive finite inputs and retain RF arrays and FFT bins at explicit numerical boundaries. | [major] | done | Codex | `crates/kwavers-diagnostics/src/workflows/fk_migration.rs`, co-located tests, ADR 083, PM artifacts; diagnostics test-target check passes; focused Nextest 3/3 with 196 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, formatting, diff, and public-signature scan pass |
| KWAVERS-AEQ-MET-45 | Type clinical monitoring temperature, timing, rate, resolution, safety, and quality metrics with Aequitas; keep timestamps, counters, and logarithmic/dimensionless formula values at explicit boundaries. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/clinical_monitoring/**`, ADR 084, PM artifacts; diagnostics test-target check passes; focused Nextest 13/13 with 186 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, package formatting, diff, and public-contract scan pass |
| KWAVERS-AEQ-MET-46 | Type real-time SIRT frame timestamps, computation budgets, elapsed computation time, throughput, convergence error, and quality ratios with Aequitas; retain RF/image arrays, grid-point smoothing, and raw intensity thresholds at explicit numerical boundaries. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/real_time_sirt/**`, ADR 085, PM artifacts; diagnostics test-target check passes; focused Nextest 14/14 with 185 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, package formatting, diff, and public-contract scan pass |
| KWAVERS-AEQ-MET-47 | Type sound-speed-shift measured travel-time samples and all prediction, fixed-acquisition, curved-array, and batch time-shift APIs with Aequitas `Time`; extract seconds only at numerical operators and retain velocity/grid/image storage as explicit boundaries for the next slice. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/sound_speed_shift/**`, ADR 086, PM artifacts |
| KWAVERS-AEQ-MET-48 | Type sound-speed-shift reference velocity, grid spacing, curved-path sagitta, and finite-frequency length scales with Aequitas `Velocity` and `Length`; extract base scalars only at ray and solver formulas, retain solver-owned coordinates and dense image storage as explicit boundaries. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/sound_speed_shift/{types,ray,propagation,operator}/**`, ADR 087, PM artifacts |
| KWAVERS-AEQ-MET-49 | Type public curved-array radius/angles and OpenPros waveform frequency with Aequitas `Length`, `Angle`, and `Frequency`; extract base scalars only for coordinate trigonometry and derived wavelength, retain solver-owned coordinates and dense/error-metric storage as explicit boundaries. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/sound_speed_shift/{curved_array,openpros_benchmark}/**`, ADR 088, PM artifacts; diagnostics test-target check passes; focused Nextest 34/34 with 165 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, package formatting, diff checks, and public-contract scan pass |
| KWAVERS-AEQ-MET-50 | Type OpenPros mean absolute and root mean square sound-speed errors with Aequitas `Velocity`; extract base scalars only inside the numerical image comparison, retain normalized/correlation/objective values and Leto image storage as explicit numerical/provider boundaries. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/sound_speed_shift/openpros_benchmark/{metrics,types,tests}.rs`, ADR 089, PM artifacts; diagnostics test-target check passes; focused Nextest 34/34 with 165 skipped; warning-denied all-target Clippy, doctests 1/1 executable with 5 ignored, RustDoc, package formatting, diff checks, and public-contract scan pass |
| KWAVERS-AEQ-MET-51 | Replace public sound-speed-shift `Array2<f64>` result fields with a typed `SoundSpeedShiftField` that owns Leto storage and exposes Aequitas `Velocity` iteration; extract raw storage only at solver/provider boundaries, with no complex physical unit. | [major] | done | Codex | `crates/kwavers-diagnostics/src/reconstruction/sound_speed_shift/{types,image,fixed_acquisition,openpros_benchmark}/**`, ADR 090, PM artifacts; diagnostics check, Nextest 199/199, warning-denied Clippy, doctest, RustDoc, format, and diff gates pass |
| KWAVERS-GEN-01 | Consolidate indexed traversal and centered-gradient variants behind monomorphized provider entrypoints; migrate all in-repository callers and remove superseded consumer adapters. | [arch] [major] | done | Codex | `leto-ops::{indexed_map_inplace,indexed_zip_mut_with}`, migrated callers, deleted consumer adapters, `crates/kwavers-simulation/Cargo.toml`, ADR 079; core 74/74, math 111/111, simulation 87/87, analysis 724/724, solver 859/859, physics 1557/1557, therapy 341/341 |

| KWAVERS-AEQ-MET-52 | Type electromagnetic specific-absorption-rate deposition with Aequitas electrical-conductivity, mass-density, SAR, and volumetric-power-density contracts; prove `σ·|E|²/ρ`, preserve real-field semantics, and keep future Eunomia complex phasors at the numerical magnitude boundary. | [arch] [major] | done | Codex | `repos/aequitas` electrical-conductivity vocabulary; `crates/kwavers-medium/src/properties/electromagnetic.rs`; `crates/kwavers-physics/src/electromagnetic/{equations/materials,sar}.rs`; ADR 091 and synchronized audit artifacts; provider commit `edf746d`; EM/SAR and phase-3d focused gates pass |
| KWAVERS-AEQ-MET-53 | Type the public therapeutic microbubble state, shell properties, radiation force, and streaming-velocity contracts with Aequitas; add provider-owned acceleration and pressure-rate vocabulary; keep Keller–Miksis/Marmottant formula scalars and future complex acoustic fields at explicit numerical boundaries. | [major] | done | Codex | `crates/kwavers-physics/src/therapy/microbubble/{state,shell,forces}/**`, direct `kwavers-therapy` callers/tests, `repos/aequitas` acceleration and pressure-rate vocabulary, ADR 092 and synchronized audit artifacts |
...
the tuple-output form of `zip_mut_with` so one-input updates and ARF
finalization share the traversal SSOT while ARF still
...
the tuple-output form of `crate::parallel::zip_mut_with`, backed by Moirai
chunk-pair scheduling for dense standard-layout arrays and sequential ndarray
traversal only for non-standard views. Evidence tier: static source audit plus
