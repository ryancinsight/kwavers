...
| KWAVERS-AEQ-MET-30 | Add Aequitas capacitance, conductance, potential, and charge dimensions, then type public sonogenetics membrane and electrical contracts without consumer wrappers. | [major] | ready | Codex | `repos/aequitas` electrical dimensions, `crates/kwavers-physics/src/acoustics/therapy/sonogenetics/**`, PM artifacts |
