...
| KWAVERS-AEQ-MET-45 | Type clinical monitoring temperature, timing, rate, resolution, safety, and quality metrics with Aequitas; keep timestamps, counters, and logarithmic/dimensionless formula values at explicit boundaries. | [major] | in-progress | Codex | `crates/kwavers-diagnostics/src/reconstruction/clinical_monitoring/**`, ADR 084, PM artifacts |
