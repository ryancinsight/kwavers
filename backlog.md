...
| KWAVERS-AEQ-MET-17 | Type the public therapy acoustic-solver time, pressure, and SPTA intensity results and carry typed time through acoustic safety/heating helper intervals; keep dense arrays and numerical formula boundaries explicit. | [major] | in-progress | Codex | `crates/kwavers-therapy/src/therapy/therapy_integration/acoustic/{fields,stepping}.rs`, associated helper callers/tests, ADR 055, PM artifacts |
