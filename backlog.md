...
| KWAVERS-AEQ-MET-44 | Type f-k migration lateral spacing, temporal sampling, and sound speed with Aequitas; validate positive finite inputs and retain RF arrays and FFT bins at explicit numerical boundaries. | [major] | in-progress | Codex | `crates/kwavers-diagnostics/src/workflows/fk_migration.rs`, co-located tests, ADR 083, PM artifacts |
