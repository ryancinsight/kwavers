...
Executable figure generation for docs/book/seismic_fwi_brain_imaging.md.
...
from seismic_fwi.roi import plot_centroid_roi_stack  # noqa: E402
from seismic_fwi.volume import (  # noqa: E402
...
def run_fwi_schedule() -> tuple[dict, dict[str, float | int], bool, int]:
    ...
    for iterations in ITERATION_SCHEDULE:
        ...
        result = kw.run_seismic_helmet_fwi_volume_from_ritk_ct(
            str(CT_PATH),
            grid_size=GRID_SIZE,
