...
```bash
python crates/kwavers-python/examples/book/ch32_segmented_tissue_transducer_optimization.py
```

Missing LiTS17 NIfTI files trigger the built-in synthetic abdominal liver
phantom automatically.

## 31.1 Planning Contract
...
`crates/kwavers-python/examples/book/ch32_segmented_tissue_transducer_optimization.py` into
