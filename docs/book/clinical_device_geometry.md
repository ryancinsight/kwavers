...
`crates/kwavers-python/examples/book/transcranial_planning/tfuscapes.py`, which reuses the
...
`crates/kwavers-python/examples/book/ch31_clinical_device_geometry.py`.
