...
therapy arrays on CT-derived patient anatomy in 3-D.  Two device analogues are
studied:

- **HistoSonics-like focused bowl** (256 elements, hemispherical cap with central
...
|-----------|-------|---------------|
| `θ_cutout` | 0.175 rad (≈ 10°) | Central cutout for co-axial imaging probe (HistoSonics H101 geometry; Vlaisavljevich et al. 2014) |
...
## Clinical Device Analogues

### HistoSonics-like Abdominal Bowl (Edison / H101)

The HistoSonics Edison system uses a 256-element, 1.5 MHz focused bowl
transducer with a central imaging cutout.  Published F-number is 0.87 with a
7.5 cm focal length.  The bowl is placed on the anterior abdominal skin with
the patient in a prone or supine position.

This chapter models the same geometry:
...
### Figure 01 — Liver: HistoSonics-like Bowl on Abdominal Skin
...
### Figure 02 — Kidney: HistoSonics-like Bowl on Abdominal Skin
