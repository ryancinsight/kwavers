...
Figures are generated by `crates/kwavers-python/examples/book/ch33_cmut_vs_pmut.py`, which calls
the Rust models through the PyO3 binding layer (physics in Rust, plotting in Python).
