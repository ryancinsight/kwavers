...
> chapter are produced by `crates/kwavers-python/examples/book/ch21_histotripsy_comparison.py`.
...
The implementation lives in `crates/kwavers-python/examples/book/ch21_histotripsy_comparison.py`
and is wired into `generate_all_figures.py` as Chapter 14.

The runnable pykwavers example
`crates/kwavers-python/examples/histotripsy_cavitation_compare.py` extends the chapter
...
- `crates/kwavers-python/examples/output/histotripsy_intrinsic_threshold_volume.png`
- `crates/kwavers-python/examples/output/histotripsy_ms_pulse_cavitation_volume.png`
- `crates/kwavers-python/examples/output/histotripsy_bubble_internal_temperature_volume.png`
- `crates/kwavers-python/examples/output/histotripsy_mechanism_compare.png`
- `crates/kwavers-python/examples/output/histotripsy_ms_pressure_response.png`
...
The example
[`crates/kwavers-python/examples/book/ch21b_liver_hcc_histotripsy_treatment.py`](../../crates/kwavers-python/examples/book/ch21b_liver_hcc_histotripsy_treatment.py)
...
A second example,
[`crates/kwavers-python/examples/book/ch21c_histotripsy_treatment_planning.py`](../../crates/kwavers-python/examples/book/ch21c_histotripsy_treatment_planning.py),
...
```bash
python crates/kwavers-python/examples/book/ch21b_liver_hcc_histotripsy_treatment.py \
