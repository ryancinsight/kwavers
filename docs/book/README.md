...
This directory is the source tree for the in-repository book on ultrasound physics for simulation, diagnostics, therapy, and theranostics. Chapters are split by physics domain and reference the production modules that implement the corresponding models.

## Chapters

- [Foundations](foundations.md)
- [Acoustic Propagation](acoustic_propagation.md)
...
- [Beamforming and Image Formation](beamforming_and_image_formation.md)
- [Therapy](therapy.md)
- [Diagnostics](diagnostics.md)
- [Theranostics](theranostics.md)
- [Photoacoustics](photoacoustics.md)
- [Elastography](elastography.md)
- [Cavitation and Bubble Dynamics](cavitation_and_bubbles.md)
- [Nonlinear Acoustics](nonlinear_acoustics.md)
- [Transcranial Ultrasound](transcranial_ultrasound.md)
- [Sonogenetics](sonogenetics.md)
- [Inverse Problems and PINNs](inverse_problems_and_pinns.md)
