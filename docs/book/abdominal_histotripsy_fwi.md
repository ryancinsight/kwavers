...
- `fig01_kidney_abdominal_fwi.png`: KiTS19 kidney targeting and lesion-state FWI.
- `fig01_liver_abdominal_fwi.png`: LiTS liver targeting and lesion-state FWI.
- `fig02_kidney_subharmonic_nonlinear_fwi.png`: KiTS19 subharmonic and
  nonlinear lesion-state channels.
- `fig02_liver_subharmonic_nonlinear_fwi.png`: LiTS subharmonic and nonlinear
  lesion-state channels.
- `metrics.json`: objective histories, Pearson correlation, NRMSE, equal-volume
  lesion Dice, lesion CNR, field of view, active voxel count, aperture geometry,
