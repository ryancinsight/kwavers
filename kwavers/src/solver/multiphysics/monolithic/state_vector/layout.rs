...
pub(in crate::solver::multiphysics::monolithic) fn sorted_field_keys(
...
/// `(n_fields*nx, ny, nz)`.
pub(in crate::solver::multiphysics::monolithic) fn flatten_fields(
    fields: &HashMap<UnifiedFieldType, Array3<f64>>,
...
pub(in crate::solver::multiphysics::monolithic) fn unflatten_fields(
    u: &Array3<f64>,
