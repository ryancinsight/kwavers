...
///
/// ```rust,ignore
/// use kwavers::solver::inverse::pinn::ml::burn_wave_equation_3d::BurnPINN3DConfig;
///
...
///
/// ```rust,ignore
/// use kwavers::solver::inverse::pinn::ml::burn_wave_equation_3d::BurnLossWeights3D;
///
...
///
/// ```rust,ignore
/// use kwavers::solver::inverse::pinn::ml::burn_wave_equation_3d::BurnTrainingMetrics3D;
///
