...
pub struct DistributedPinnTrainer<B: AutodiffBackend> {
    ...
    /// Multi-GPU manager
    multi_gpu_manager: Option<crate::solver::inverse::pinn::ml::MultiGpuManager>,
...
impl<B: AutodiffBackend> DistributedPinnTrainer<B> {
    ...
    pub async fn new(
        config: DistributedTrainingConfig,
        base_config: crate::solver::inverse::pinn::ml::BurnPINN2DConfig,
...
mod tests {
    ...
    async fn test_distributed_trainer_creation() {
        ...
        let geometry =
            crate::solver::inverse::pinn::ml::Geometry2D::rectangular(0.0, 1.0, 0.0, 1.0);
