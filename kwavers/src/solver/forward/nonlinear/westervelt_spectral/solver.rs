...
//!
//! Pressure buffers are rotated using index permutation (zero-copy update):
//! `buffer_indices = [next, current, previous]` cycles each step without allocation.
//!
//! ## References
...
//! - Treeby, B.E. & Cox, B.T. (2010). Modeling power law absorption and dispersion in
//!   viscoelastic solids using a split-field and the fractional Laplacian.
