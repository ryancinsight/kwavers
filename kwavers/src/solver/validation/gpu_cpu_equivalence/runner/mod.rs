...
use crate::domain::signal::traits::Signal;
...
fn run_simulation_cpu(
    ...
    let grid_source = GridSource {
        ...
        p_mode: crate::domain::source::grid_source::SourceMode::Additive,
        u_mask: None,
        u_signal: None,
        u_mode: crate::domain::source::grid_source::SourceMode::Additive,
    };
