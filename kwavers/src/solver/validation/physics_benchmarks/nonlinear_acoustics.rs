...
use crate::solver::forward::nonlinear::kuznetsov::config::{AcousticEquationMode, KuznetsovConfig};
use crate::solver::forward::nonlinear::kuznetsov::solver::KuznetsovWave;
...
mod tests {
    ...
    #[test]
    fn test_kuznetsov_second_harmonic() -> Result<(), crate::core::error::KwaversError> {
        ...
        use crate::solver::forward::nonlinear::kuznetsov::AcousticEquationMode;
