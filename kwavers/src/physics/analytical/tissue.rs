...
use crate::core::constants::tissue_acoustics::{
    DENSITY_BLOOD, DENSITY_BRAIN, DENSITY_CARTILAGE, DENSITY_FAT, DENSITY_KIDNEY, DENSITY_LIVER,
    DENSITY_MUSCLE, SOUND_SPEED_BLOOD, SOUND_SPEED_BRAIN, SOUND_SPEED_CARTILAGE, SOUND_SPEED_FAT,
...
pub fn tissue_properties(tissue: &str) -> (f64, f64, f64, f64, f64) {
    ...
    match tissue {
        "water" => (SOUND_SPEED_WATER, DENSITY_WATER, 0.002, 2.0, 5.2),
        ...
        "skull" => (SOUND_SPEED_SKULL, BONE_DENSITY, 13.0, 1.2, 12.0),
