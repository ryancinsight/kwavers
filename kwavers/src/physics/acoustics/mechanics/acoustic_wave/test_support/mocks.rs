...
use crate::domain::medium::{acoustic, bubble, core, elastic, optical, thermal, viscous};
#[cfg(test)]
...
impl core::CoreMedium for HeterogeneousMediumMock {
...
impl core::ArrayAccess for HeterogeneousMediumMock {
...
impl acoustic::AcousticProperties for HeterogeneousMediumMock {
...
impl elastic::ElasticProperties for HeterogeneousMediumMock {
    ...
    fn shear_wave_speed(&self, x: f64, y: f64, z: f64, grid: &Grid) -> f64 {
        if self.position_dependent {
            ...
            let rho = crate::domain::medium::density_at(self, x, y, z, grid);
            if mu > 0.0 {
                (mu / rho).sqrt()
            } else {
                0.0
    ...
    fn compressional_wave_speed(&self, x: f64, y: f64, z: f64, grid: &Grid) -> f64 {
        crate::domain::medium::sound_speed_at(self, x, y, z, grid)
    }
}

impl elastic::ElasticArrayAccess for HeterogeneousMediumMock {
...
// Thermal properties
impl thermal::ThermalProperties for HeterogeneousMediumMock {
...
impl viscous::ViscousProperties for HeterogeneousMediumMock {
    fn viscosity(&self, _x: f64, _y: f64, _z: f64, _grid: &Grid) -> f64 {
        0.001 // Pa·s (water at 20°C)
    }
}

impl optical::OpticalProperties for HeterogeneousMediumMock {
...
impl thermal::ThermalField for HeterogeneousMediumMock {
...
impl bubble::BubbleProperties for HeterogeneousMediumMock {
...
impl bubble::BubbleState for HeterogeneousMediumMock {
