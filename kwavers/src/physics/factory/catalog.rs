...
//!
//! [`HybridSpectralDGSolver`]: crate::solver::pstd::dg::HybridSpectralDGSolver
//! [`BubbleDynamicsPlugin`]: crate::solver::forward::bubble_dynamics::plugin::BubbleDynamicsPlugin

use crate::core::error::{ConfigError, KwaversError, KwaversResult};
use crate::domain::grid::Grid;
use crate::domain::medium::Medium;
use crate::domain::plugin::Plugin;
use crate::physics::factory::config::PhysicsConfig;
use crate::physics::factory::models::{AcousticSolver, NonlinearEquation, PhysicsModelType};
use crate::physics::thermal::diffusion::ThermalDiffusionConfig;
use crate::solver::fdtd::FdtdConfig;
use crate::solver::forward::bubble_dynamics::plugin::{BubbleDynamicsConfig, BubbleDynamicsPlugin};
use crate::solver::forward::fdtd::plugin::FdtdPlugin;
use crate::solver::forward::nonlinear::kzk_solver_plugin::KzkSolverPlugin;
use crate::solver::forward::pstd::plugin::PSTDPlugin;
use crate::solver::forward::thermal_diffusion::plugin::ThermalDiffusionPlugin;
        ...
        match kind {
            ...
            PhysicsModelType::BubbleDynamics { model, nucleation } => {
                let config = BubbleDynamicsConfig {
                    ...
                    params: crate::physics::acoustics::bubble_dynamics::bubble_state::BubbleParameters::default(),
                };
