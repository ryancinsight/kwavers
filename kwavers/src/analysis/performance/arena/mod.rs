//! Arena Allocators — re-exported from the canonical SSOT at [`crate::core::arena`].
// This module is a pure re-export shim. All types are defined in crate::core::arena.
//!
//! All arena types are defined in `kwavers::core::arena`.
//! This module is a thin re-export shim so that existing import paths of the form
//! `crate::analysis::performance::arena::*` continue to compile without change.
...
pub use crate::core::arena::batch::{
...
pub use crate::core::arena::pool::{
    BufferBatch, BufferPool, NumaPoolManager, PoolConfig, PoolStats, PooledBuffer,
    DEFAULT_POOL_CAPACITY,
};
pub use crate::core::arena::simulation_arena::{ThreadLocalArena, ThreadLocalFieldGuard};
pub use crate::core::arena::temp_arena::{BumpAllocator, ScopedArena};
