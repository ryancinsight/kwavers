...
use crate::domain::source::{GridSource, Source as KwaversSource};
use crate::physics::acoustics::mechanics::absorption::AbsorptionMode;
use crate::simulation::configs::ThermalConfig;
use crate::simulation::dispatch::shared::{record_modes_to_spec, trim_initial_recorder_view};
...
pub fn run_with_thermal(
    ...
    solver.run_orchestrated_with_thermal(
        crate::solver::forward::pstd::implementation::core::orchestrator::thermal::ThermalOrchestrationInput {
