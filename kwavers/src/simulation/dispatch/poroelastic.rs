...
use crate::physics::acoustics::mechanics::poroelastic::material::PoroelasticMaterial;
use crate::simulation::types::{SimulationRunRequest, SimulationRunResult};
use crate::solver::forward::poroelastic::PoroelasticSolver;
...
mod tests {
    ...
    use crate::simulation::configs::PoroelasticConfig;
    ...
    fn make_request<'a>(
        grid: &'a Grid,
        medium: &'a dyn crate::domain::medium::traits::Medium,
