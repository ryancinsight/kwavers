...
use crate::domain::medium::traits::Medium as MediumTrait;
use crate::domain::sensor::recorder::pressure_statistics::SampledStatistics;
use crate::domain::sensor::recorder::simple::SensorRecorder;
use crate::domain::source::GridSource;
use crate::simulation::configs::{HelmholtzConfig, NonlinearConfig, PmlConfig, PoroelasticConfig, ThermalConfig};
use crate::solver::config::SolverType;
use crate::solver::forward::fdtd::config::KSpaceCorrectionMode;
use crate::solver::forward::pstd::config::CompatibilityMode;
...
pub struct SimulationRunResult {
    ...
    pub velocity_stats: Option<crate::domain::sensor::recorder::velocity_statistics::SampledVelocityStats>,
...
pub struct SimulationRunRequest<'a> {
    ...
    pub transducers_for_rs: &'a [crate::domain::source::array_2d::TransducerArray2D],
