...
// ============================================================================
// AI-Enhanced Beamforming Types
// ============================================================================

/// AI-Enhanced Beamforming Configuration
///
...
/// AI-Enhanced Beamforming Result
///
/// Complete result from neural-enhanced beamforming including volume reconstruction,
/// uncertainty quantification, feature maps, and clinical analysis.
#[derive(Debug)]
...
/// Performance Metrics for AI Beamforming
///
/// Tracks execution time for each processing stage and resource usage.
#[derive(Debug, Clone)]
