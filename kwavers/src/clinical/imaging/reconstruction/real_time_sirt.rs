...
///
/// Defines the transducer array configuration used to construct the system
/// matrix **A**, where the matrix element A[s, v] encodes how strongly sensor
/// *s* "sees" voxel *v*:
///
/// ```text
...
fn project_acoustic(image: &Array3<f64>, geom: &AcousticProjectionGeometry) -> Array1<f64> {
