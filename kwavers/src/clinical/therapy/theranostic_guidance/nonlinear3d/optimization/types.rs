...
pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) struct LineSearchInput<'a> {
...
#[derive(Clone, Debug)]
pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) struct LineSearchWorkspace {
    pub(super) candidate_speed: Vec<f64>,
    pub(super) candidate_beta: Vec<f64>,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) enum AcceptedBlock {
    Coupled,
    SpeedOnly,
    BetaOnly,
}
...
impl AcceptedBlock {
    pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) fn label(
        self,
    ) -> &'static str {
        match self {
...
pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) struct LineSearchOutcome {
    pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) accepted_block:
        AcceptedBlock,
    pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) scale: f64,
    pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) objective: f64,
}
...
impl LineSearchWorkspace {
    #[must_use]
    pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) fn new(
        cells: usize,
    ) -> Self {
        Self {
...
pub(in crate::clinical::therapy::theranostic_guidance::nonlinear3d) struct ObjectiveInput<'a> {
    pub observed: &'a [EncodedTrace],
    pub observed_energy: f64,
    pub density: &'a [f64],
    pub attenuation_np_per_m_mhz: &'a [f64],
