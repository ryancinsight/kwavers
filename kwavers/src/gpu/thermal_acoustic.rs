...
///
/// Field names use physics notation (e.g., `dc_dT` = ∂c/∂T) to match
/// the mathematical specification and WGSL shader variable names.
#[derive(Debug, Clone, Copy)]
#[repr(C)]
#[derive(bytemuck::Pod, bytemuck::Zeroable)]
#[allow(non_snake_case)] // Physics notation: dc/dT, dρ/dT, T_ref, etc.
...
pub struct GpuThermalAcousticBuffers {
    ...
    /// Acoustic heating source (Q_ac = α|p|²/(ρc))
    #[allow(non_snake_case)] // Physics notation
