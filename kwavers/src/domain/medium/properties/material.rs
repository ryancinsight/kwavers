...
mod tests {
    ...
    fn test_material_creation() {
        let mat = AcousticMaterialProperties::new(SOUND_SPEED_WATER_SIM, 1000.0, 0.002, SPECIFIC_HEAT_WATER, 0.6);
    ...
    fn test_validation_invalid_speed() {
        let mut mat = AcousticMaterialProperties::new(SOUND_SPEED_WATER_SIM, 1000.0, 0.002, SPECIFIC_HEAT_WATER, 0.6);
    ...
    fn test_impedance_match() {
        let mat = AcousticMaterialProperties::new(SOUND_SPEED_WATER_SIM, 1000.0, 0.002, SPECIFIC_HEAT_WATER, 0.6);
        let same = AcousticMaterialProperties::new(SOUND_SPEED_WATER_SIM, 1000.0, 0.002, SPECIFIC_HEAT_WATER, 0.6);
