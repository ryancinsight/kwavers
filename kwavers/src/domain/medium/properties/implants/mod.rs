...
use crate::core::constants::implants::{
    ...
    SOUND_SPEED_PLATINUM, SOUND_SPEED_PMMA, SOUND_SPEED_POLYURETHANE, SOUND_SPEED_SILICONE_RUBBER,
    SOUND_SPEED_STAINLESS_STEEL_316L, SOUND_SPEED_TITANIUM_GRADE5, SOUND_SPEED_UHMWPE,
    SOUND_SPEED_ZIRCONIA, SPECIFIC_HEAT_ALUMINA, SPECIFIC_HEAT_CFRP, SPECIFIC_HEAT_HYDROXYAPATITE,
    SPECIFIC_HEAT_PLATINUM, SPECIFIC_HEAT_PMMA, SPECIFIC_HEAT_POLYURETHANE,
    SPECIFIC_HEAT_SILICONE_RUBBER, SPECIFIC_HEAT_STAINLESS_STEEL_316L, SPECIFIC_HEAT_TITANIUM,
    SPECIFIC_HEAT_UHMWPE, SPECIFIC_HEAT_ZIRCONIA, THERMAL_CONDUCTIVITY_ALUMINA,
    THERMAL_CONDUCTIVITY_CFRP, THERMAL_CONDUCTIVITY_HYDROXYAPATITE, THERMAL_CONDUCTIVITY_PLATINUM,
    THERMAL_CONDUCTIVITY_PMMA, THERMAL_CONDUCTIVITY_POLYURETHANE,
