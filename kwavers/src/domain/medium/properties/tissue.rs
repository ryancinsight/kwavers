...
use crate::core::constants::thermodynamic::{
    ...
    SPECIFIC_HEAT_MUSCLE, SPECIFIC_HEAT_TISSUE, SPECIFIC_HEAT_WATER, THERMAL_CONDUCTIVITY_BLOOD,
    THERMAL_CONDUCTIVITY_BRAIN, THERMAL_CONDUCTIVITY_BRAIN_GRAY, THERMAL_CONDUCTIVITY_CSF,
    THERMAL_CONDUCTIVITY_FAT, THERMAL_CONDUCTIVITY_KIDNEY, THERMAL_CONDUCTIVITY_LIVER,
    THERMAL_CONDUCTIVITY_MUSCLE, THERMAL_CONDUCTIVITY_SKULL, THERMAL_CONDUCTIVITY_WATER,
    THERMAL_DIFFUSIVITY_WATER,
};
