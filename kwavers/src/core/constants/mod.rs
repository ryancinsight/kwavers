...
pub use fundamental::{
    ...
    DENSITY_TISSUE, DENSITY_WATER_37C, DENSITY_WATER_NOMINAL, GAS_CONSTANT, GRAVITY,
...
pub use medical::{
    ...
    MI_LIMIT_SOFT_TISSUE, THERMAL_DOSE_REFERENCE_TEMP_C, THERMAL_DOSE_R_ABOVE_43C,
    THERMAL_DOSE_R_BELOW_43C, THERMAL_DOSE_THRESHOLD, TI_LIMIT_SOFT_TISSUE,
};
