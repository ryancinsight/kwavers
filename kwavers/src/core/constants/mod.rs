...
pub use acoustic_parameters::{
    ...
    DENSITY_SKULL, DIAGNOSTIC_FREQ_MAX,
    DIAGNOSTIC_FREQ_MIN, NP_TO_DB, REFERENCE_FREQUENCY_HZ, REFERENCE_FREQUENCY_MHZ,
    REFERENCE_FREQUENCY_TISSUE_HZ, SAMPLING_FREQUENCY_DEFAULT, VISCOSITY_SOFT_TISSUE,
