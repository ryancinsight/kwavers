...
use kwavers::{
    domain::grid::Grid,
    domain::medium::HomogeneousMedium,
    domain::source::GridSource,
    solver::forward::fdtd::{FdtdConfig, FdtdSolver},
};
...
fn setup_plane_wave_problem(
    ...
    frequency_hz: f64,
    sound_speed: f64,
) -> Result<(Grid, HomogeneousMedium, GridSource, f64), kwavers::KwaversError> {
