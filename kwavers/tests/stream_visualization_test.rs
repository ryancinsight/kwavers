...
use kwavers::analysis::visualization::stream::pipeline::PipelineConfig;
use kwavers::analysis::visualization::stream::sync::{report_sync_metrics, QualityLevel};
use kwavers::analysis::visualization::stream::{
...
fn create_test_frame(id: u64, grid_size: usize) -> VizFrame {
    ...
    let metadata = FrameMetadata {
        id: kwavers::analysis::visualization::stream::FrameId(id),
...
fn test_stream_frame_id_uniqueness() {
    ...
    let ids: Vec<_> = (0..1000)
        .map(|_| kwavers::analysis::visualization::stream::FrameId::next(&counter))
        .collect();
...
fn test_quality_level_transitions() {
    use kwavers::analysis::visualization::stream::sync::QualityLevel;
